...
public class DryingTableScreen extends AbstractContainerScreen<DryingTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(PoppyDelight.MODID, "textures/gui/dryingtable_gui.png");
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            ...
            guiGraphics.blit(TEXTURE, x + 49, y + 30, 176, 0, 8, menu.getScaledProgress());
            guiGraphics.blit(TEXTURE, x + 121, y + 30, 176, 0, 8, menu.getScaledProgress());
        }
    }
